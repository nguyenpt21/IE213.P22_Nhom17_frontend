...
const Home = () => {
    ...
    return (
        <div className="mb-20">
                    ...
                    <div className="flex items-center gap-1">
                        <div className="w-[40%] bg-inherit">
                            ...
                            <p className="text-[18px] mt-6 text-gray-400 font-medium">
                                Khám phá niềm vui của bạn mọi lúc, mọi nơi - từ
                                chuyến du lịch ngẫu hứng tới những cuộc phiêu
                                lưu khắp thế giới
                            </p>
                        </div>
            ...
            <Tooltip title="Bạn có tin nhắn mới" open={unreadCount[users[0]?._id] > 0} placement="leftTop" color={'#108ee9'}>
                <div
                    className="fixed bottom-1/4 right-14 w-14 h-14 bg-gradient-to-br from-blue-400 to-blue-600 text-white flex items-center justify-center rounded-full cursor-pointer shadow-md hover:shadow-lg transition duration-300 z-50"
                    onClick={() => navigate('/user/customer-support')}
                >
                    <span className="text-[28px] text-blue-700">
                        <BiSupport />
                    </span>
                </div>
            </Tooltip>
